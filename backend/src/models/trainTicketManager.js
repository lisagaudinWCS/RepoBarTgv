...
class trainsTicketsClients extends AbstractManager {
  ...
  getTrainsTicketsClients() {
    return this.connection.query(
      `SELECT ti.id, t.train_number, t.dep_from, t.arr_to, t.departure_time, t.arrival_time, ti.coach, ti.seat, ti.date, c.firstname, c.lastname FROM ${this.table} as t
      INNER JOIN ticket as ti ON t.id=ti.train_id
      INNER JOIN client as c ON ti.client_id=c.id;`
    );
  }
}
